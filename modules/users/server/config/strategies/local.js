        ...
        User.update({username: user, block: false}, {block: true, openCode: code}, function(err, doc){
          ...
          User.find({username: user}, function(err, reUser){
            ...
            emailServer.send({
              ...
              attachment: 
              [
                {data:"<html><h1>You Account is blocked</h1> Click <a href='https://iclouddev.herokuapp.com/api/unblock_user/" + reUser[0].openCode + "'>here</a> To unlock your account </html>", alternative:true} 
              ]
