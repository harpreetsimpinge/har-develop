      ...
      return res.status(400).send({
        ...
        if(req.body.type == "closing") {
            Note.findOne({
                ...
                console.log(new Date(2018, 5, 11));
                ...
                // mongoose.connection.db.collection('articles').update({ _id: user.article },
                //     { $set:{"DateClosedFocusInformation.value":"2017-5-11"}}, function(err, doc) {
                //     console.log(err);
                //     if (err) {
                ...
                MongoClient.connect('mongodb://127.0.0.1:27017/test', function(err, db) {
                    if(err) throw err;
console.log("5845fc4d7caa400f00604fc7");
