...
console.log($scope.notes);
      ...
      console.log($scope.notes);
      //console.log("workface old price = "+allNotesWorkstatusPrice);
      var allNotesWorkstatusPrice = 0;
      $scope.isNotesReady = true;
      for(var k=0; k<$scope.notes.length; k++) {

        if($scope.notes[k].workface.price != "") {
        ...
        //console.log("workface price = "+allNotesWorkstatusPrice+" = "+$scope.notes[k].workface.price);
      }
      //console.log(allNotesWorkstatusPrice);
      $scope.allNotesWorkstatusPrice = allNotesWorkstatusPrice;
      console.log("Article Notes ----");
      console.log($scope.allNotesWorkstatusPrice);
      $scope.isNotesReady = true;
    };
